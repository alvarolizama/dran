...
| `plan`       | Time-horizoned plans          | —                                                     | kind (personal/coding/business/learning/health/finance/other), horizon (weekly/monthly/quarterly/yearly), status (draft/active/done/archived), period, due_date, project_slug, goal_slug |

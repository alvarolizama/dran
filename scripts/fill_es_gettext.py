...
ES = {
    ...
    "API admin token and the instance default workspace.": "Token de admin del API y el espacio de trabajo por defecto de la instancia.",
    "Used when a user has no workspace of their own and no active session.": "Se usa cuando un usuario no tiene un espacio de trabajo propio ni una sesión activa.",
    "Set by the workspace flagged as default.": "Lo define el espacio de trabajo marcado como por defecto.",
    "No workspace is flagged as default — flag one in Workspaces to control this.": "Ningún espacio de trabajo está marcado como por defecto — márcalo en Espacios de trabajo para controlarlo.",
    "Create workspaces and manage access per user.": "Crea espacios de trabajo y administra el acceso por usuario.",
    "Could not delete workspace": "No se pudo eliminar el espacio de trabajo.",
    'Workspace "%{name}" deleted': 'Espacio de trabajo "%{name}" eliminado',
    ...
    "Details": "Detalles",
    "Disabled types are hidden in the web UI and rejected by the agent tools for this workspace.": "Los tipos deshabilitados se ocultan en la interfaz web y las herramientas de agente los rechazan en este espacio de trabajo.",
    "Disk": "Disco",

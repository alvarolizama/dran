defmodule DranWeb.PageCardComponents do
  ...
  defp page_url(%{page_type: "concept", slug: s}), do: "/concepts/#{s}"
  defp page_url(%{page_type: "entity", slug: s}), do: "/entities/#{s}"
  defp page_url(%{page_type: "reference", slug: s}), do: "/references/#{s}"
  defp page_url(%{page_type: "project", slug: s}), do: "/projects/#{s}"
  defp page_url(%{page_type: "goal", slug: s}), do: "/goals/#{s}"
  defp page_url(%{page_type: "plan", slug: s}), do: "/plans/#{s}"
  defp page_url(%{page_type: "todo", slug: s}), do: "/todos/#{s}"
  defp page_url(%{page_type: "query", slug: s}), do: "/queries/#{s}"
  defp page_url(_), do: "#"
end

defmodule Dran.MixProject do
  ...
  defp aliases do
    [
      setup: ["deps.get", "ecto.create", "ecto.migrate", "assets.setup", "assets.build", "seed"],
      "ecto.setup": ["ecto.create", "ecto.migrate"],
      "ecto.reset": ["ecto.drop", "ecto.create", "ecto.migrate", "seed"],
      seed: ["run priv/repo/seeds.exs"],
      test: ["ecto.create --quiet", "ecto.migrate --quiet", "test"],
      "assets.setup": ["tailwind.install --if-missing", "esbuild.install --if-missing"],
      "assets.build": ["compile", "tailwind dran", "esbuild dran"],
      "assets.deploy": [
        "tailwind dran --minify",
        "esbuild dran --minify",
        "phx.digest"
      ],

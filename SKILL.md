...
| `todo` | Actionable items | personal, coding, business, learning, health, finance, other | kind, kanban_status, priority, due_date, project_slug, goal_slug, plan_slug, assignee |
